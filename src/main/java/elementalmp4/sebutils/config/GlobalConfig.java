...
public enum GlobalConfig {
    ...
    DISCORD_ENABLED("Discord Integration", "discord_enabled", "false", DataType.TOGGLE, "Discord", DiscordModule.class),
    DISCORD_APPROVAL_ENABLED("Access Request via Discord", "discord_access_control_enabled", "false", DataType.TOGGLE, "Discord", DiscordModule.class),
